...
//   const isLoggedIn = !!localStorage.getItem("token"); // 🎯 Destructure addCart from the context

//   //   const { addCart } = cartAuth(); // 🔹 Fetch product + related
...
//   if (!product) return <div>Product not found</div>; // 🔹 Quantity change
